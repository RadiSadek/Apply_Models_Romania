...
flag_bad_office <- function(var_off){
  return(
    ifelse(
     var_off %in% c("33","28","27","45","47","41","54","51","29","5","19",
                    "3","22","57","49","20","35","13","24","2","16","4","18",
                    "34","1"), 1,
    ifelse(
     var_off %in% c("30","12","36","31","26","11","44","38","14","7","10","42",
                    "39","25","9","17","32","56","15"), 2,
    ifelse(
     var_off %in% c("53","48","58","43","55","52","37","8","21","23","40"), 3,
    ifelse(
     var_off %in% c("59","60"), 4, 2
    )))))
}
